...
I started by cleaning the data in MySQL removing currency symbols, correcting date formats, and converting text fields into proper numeric and date types using functions like REPLACE(), STR_TO_DATE(), and CAST(). This made the dataset ready for analysis.
